...
**Query 1:**<br><br>
Escreva uma query que retorna qual estudante fez qual disciplina do próprio orientador. Retorne apenas o nome do estudante, do professor e da disciplina.<br>

**Query 2:**<br><br>
Escreva uma query que retorna qual sala (prédio e número) cada professor dá aula?<br>

**Query 3:**<br><br>
Escreva uma query que retorna qual o nome, orçamento, total de alunos e salário médio de cada departamento?<br>
([
  {
    $lookup: {
      from: "student",
